## NOTE: This was built following a guide, it was my introduction to building larger games on python
...
background = pygame.image.load("fruitninja/back.jpg")                                  #game background
font = pygame.font.Font(os.path.join(os.getcwd(), 'fruitninja/comic.ttf'), 42)
score_text = font.render('Score : ' + str(score), True, (255, 255, 255))    #score display
lives_icon = pygame.image.load('fruitninja/images/white_lives.png')                    #images that shows remaining lives

# Generalized structure of the fruit Dictionary
def generate_random_fruits(fruit):
    fruit_path = "fruitninja/images/" + fruit + ".png"
    data[fruit] = {
...
def hide_cross_lives(x, y):
    gameDisplay.blit(pygame.image.load("fruitninja/images/red_lives.png"), (x, y))
...
while game_running :
    if game_over :
        ...
        game_over = False
        player_lives = 3
        draw_lives(gameDisplay, 690, 5, player_lives, 'fruitninja/images/red_lives.png')
        score = 0
        ...
        if value['throw']:
            ...
            if not value['hit'] and current_position[0] > value['x'] and current_position[0] < value['x']+60 \
                ...
                if key == 'bomb':
                    ...
                    half_fruit_path = "fruitninja/images/explosion.png"
                else:
                    half_fruit_path = "fruitninja/images/" + "half_" + key + ".png"
